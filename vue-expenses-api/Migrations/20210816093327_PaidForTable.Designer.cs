...
namespace vue_expenses_api.Migrations
{
    ...
    [Migration("20210816093327_PaidForTable")]
    partial class PaidForTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vue_expenses_api.Domain.ExpensePaidFor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("vue_expenses_api.Domain.ExpensePaidFor", b =>
                {
                    b.HasOne("vue_expenses_api.Domain.Expense", "Expense")
                        .WithMany("PaidFor")
                        .HasForeignKey("ExpenseId");

                    b.HasOne("vue_expenses_api.Domain.ExpenseType", "ExpenseType")
                        .WithMany("PaidFor")
