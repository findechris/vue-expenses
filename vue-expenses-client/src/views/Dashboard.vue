        ...
        <v-container>
            <v-layout row justify-space-between>
                ...
                <v-flex xs12 md6>
                    <v-card
                        :class="{
                            'pa-2 mr-2 mt-2': $vuetify.breakpoint.smAndDown,
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                <div>
                                    {{
                                        `${user.displayCurrency} ${monthlyBudget.totalBudget}`
                                    }}
                                </div>
                            </div>
                            <div>
                                ...
                                <div>
                                    {{
                                        `${user.displayCurrency} ${monthlyBudget.totalSpent}`
                                    }}
                                </div>
                            </div>
                        </div>
                    ...
                    <v-container px-0 pb-0>
                        <v-card class="pa-2 mr-2" tile>
                            <div
                                ...
                                "
                            >
                                Budgets By Categories (Current Month)
                            </div>
                            <v-divider></v-divider>
